...
export class AddSponsor extends Vue {
  ...
  watchMenuOpen(newVal, oldVal) {
    ...
    if (newVal && newVal.length > 0) {
      ...
      this.id = newVal[0].id;
      document.getElementById("addSponsorbtn").innerHTML =
        '<i class="fal fa-edit"></i> Edit Sponsor';
      document.querySelector(".sponsor-modal .Card__title").innerHTML =
        "Edit Sponsor";
      ...
      this.logo = "";
      document.getElementById("addSponsorbtn").innerHTML =
        '<i class="fal fa-plus"></i> Add Sponsor';
      document.getElementById("btnSponsor").innerHTML = "Save Sponsor";
      document.querySelector(".sponsor-modal .Card__title").innerHTML =
        "Add Sponsor";
